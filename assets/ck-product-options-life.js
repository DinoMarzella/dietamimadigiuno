        ...
        <span
          :class='
            ...
            "!flex items-center justify-center w-8 h-8 border rounded-full",
             checked ? "border bg-prolon_green border-transparent": "border border-gray-300"
        ...
        <span class="flex">
          <span v-if="isMain" class=" text-base  mr-[10px] font-semibold text-left block">
            ...
            <span
              ...
              v-if="false && isMain && variant && variant.option2 && savingValue && variant.option2.toLowerCase().includes('subscri')"
        ...
        <span
          ...
          <div
            ...
            style="padding: 0px;
                ...
                fill: white;
                color: white;"
            class="css-1t2v0b6 em7gzp65 plus-icon flex justify-center items-center z-10 absolute bottom-[10px]"
  ...
  template: /*html*/ `
     <div
        ...
        >
          ...
          <div
            :class="[
              'buttonsfloat css-8clgp2 em7gzp67 z-20 border-[2px] border-prolon_primary',
...
const SingleProductSectionShopNowUpsell = {
  ...
  <div class="fixed inset-0 z-10 w-screen overflow-y-auto"><div class="flex min-h-full items-end justify-center p-0  text-center sm:items-center sm:p-0"><!--
      ...
      --><div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"  @click="closeQuickView"></div><!--  close svg -->
        ...
        <div class="fixed bottom-0 md:relative transform  text-left  transition-all sm:my-8 sm:w-full sm:max-w-[700px] 2xl:max-w-[50%] w-full m:h-[90vh]  sm:align-middle sm:rounded-lg sm:shadow-xl px-2" 
      ...
      ><span class="sr-only">Close</span><!-- Heroicon name: outline/x --><svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div><div class="pl-wrapper pl-wrapper-product-section h-full bg-white px-4 py-2 overflow-x-hidden overflow-y-scroll loaded_animation"><div class="relative"><div class="mx-auto pt-0  lg:max-w-[1600px] sm:px-[20px] md:px-[0px]"><h1 class="font-avant my-[10px] md:my-[40px] text-3xl md:text-5xl text-center text-prolon">Enhance Your Results</h1>  <h3 class="font-[600] mb-[10px] md:mb-10 md:mt-[10px] text-xl md:text-4xl text-[#98ca3c] text-center md:tracking-wider !hidden">Upgrade to a longevity bundle</h3>
  
<div class="md:grid md:grid-cols-6 lg:grid-cols-6 lg:grid-rows-1 lg:gap-x-8 lg:gap-[30px] xl:gap-[50px]"><div class="md:col-span-3 lg:col-span-4 lg:row-end-1 lg:px-0"><div class="flex flex-col"><div class="w-full aspect-w-1 aspect-h-1 flex flex-nowrap md:grid md:grid-cols-2 gap-2 md:justify-center md:items-center overflow-x-scroll overflow-y-hidden md:overflow-hidden"><div class="shrink-0  col-span-2 md:!max-w-full  hero__animation-contents relative " style="transition-delay: 1.2s;"><img src="https://cdn.shopify.com/s/files/1/0508/0625/9870/files/BundlePopup-FB-FS-Tote-Green.jpg?v=1700083814" class="!w-auto md:!w-full md:!max-w-full min-h-[350px] m:!max-h-[350px] md:!h-full !object-cover" alt="Product image" loading="eager"></div><img class="col-span-2 !hidden !max-w-full !h-auto !object-contain" src="https://cdn.shopify.com/s/files/1/0126/2921/3243/files/pl-Featured.png?v=1690546584&amp;width=2754&amp;height=129"></div></div></div><div class="w-full max-w-3xl mx-auto mt-4 sm:mt-4 md:col-span-3 lg:col-span-5 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none product-details lg:sticky lg:top-[60px]   lg:max-h-[850px]   mh900:top-[100px] px-0 md:px-[15px] "><div class="flex flex-col justify-center items-start m:mb-[120px]"><h1  class="w-full text-left text-[15px]  font-bold  text-gray-900 sm:text-[17px] mt-[10px]">Longevity & Metabolic Health<br>
+ Weight & Maintenance Optimization</h1><div class="flex items-end justify-start gap-3 "><span class="font-bold text-gray-900 text-md mt-2 blocktext-left font-semibold text-gray-900 text-[16px] md:text-[20px]">€62</span><s class="mt-2 block  text-left font-semibold text-gray-400 text-[14px] md:text-[16px] ">$78</s><span class="mt-2 block  text-left font-semibold text-black text-[14px] md:text-[16px]"></span></div><div class="mt-4 w-full product-description"><p>Stay on track and always look and feel your best with the Prolon tools you need for continued health benefits after you complete your 5-Day Program. 
    </p><ul class="my-4">  
        <li>9 Fasting Shakes</li>  
<li>9 Fasting Bars</li> 
<li>Free Reusable Prolon Tote</li></ul>
  ...
  const productForm = Vue.createApp({
    ...
    methods: {
      ...
      discountedPrice(variant) {
        ...
        // Prezzo originale della variante (o da window.finalProductPrice)
        let price = window.finalProductPrice?.[variant.id] || variant.price;

        // Verifica se la variante è Subscription (basato sul nome opzione)
        const isSubscription =
          variant.option2?.toLowerCase().includes("subscri") ||
          variant.option3?.toLowerCase().includes("subscri");

        // Applica lo sconto se è Subscription e c'è un piano selezionato
        const selectedPlan = this.selected_plan;
        if (isSubscription && selectedPlan?.price_adjustments?.length) {
          const adjustment = selectedPlan.price_adjustments[0];

          if (adjustment.value_type === "percentage") {
            price = price * (1 - adjustment.value / 100);
          } else if (adjustment.value_type === "fixed_amount") {
            price = price - adjustment.value;
          }
        }

        return Math.round(price * 100) / 100; // mantiene due decimali
      },
