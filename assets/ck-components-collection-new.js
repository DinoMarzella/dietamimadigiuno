    ...
    <div class="flex relative py-[10px] m:pr-[15px]">
      ...
      >
        <span 
          ...
          class="p-1  hidden bg-[#ffe667] rounded-sm text-[10px]  !top-[1px] !right-[6px]">
...
const SingleProductSectionShopNow = {
  template: /*html*/ `
    <a 
      class="block mt-[1.3rem] py-3 px-7 w-full text-[14px] md:text-xl leading-6  font-medium text-center text-white hover:text-white bg-[#73994a] hover:bg-[#78A117] cursor-pointer open-quick-view" 
      aria-label="Shop Now"
      @click="openQuickView"
      >
      <span class="flex items-center justify-center gap-2 mx-auto text-white max-w-prose inherit text-copy">
        <span class=" font-semibold uppercase ">Shop Now</span>
      ...
      >
        <div class="mx-auto pt-0  lg:max-w-[1600px] sm:px-[20px] md:px-[0px]">
          <div class="md:grid md:grid-cols-6 lg:grid-cols-6 lg:grid-rows-1 lg:gap-x-8 lg:gap-[30px] xl:gap-[50px]">
            <div class="md:col-span-3 lg:col-span-4 lg:row-end-1 lg:px-0">
              <div class="flex flex-col">
                ...
                >
                      ...
                      :src="productSettings.image" 
                      />  
                      <img
                      style="transition-delay: {{forloop.index | times: 0.4}}s"   
                      :src="productSettings.image_hover" 
                      />  
            ...
            <div class="w-full max-w-3xl mx-auto mt-4 sm:mt-16 md:col-span-3 lg:col-span-5 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none product-details lg:sticky lg:top-[60px]   lg:max-h-[850px]   mh900:top-[100px] px-0 md:px-[15px] lg:px-[30px] lg:pl-0  2xl:px-[60px] ">
              <div class="flex flex-col justify-center items-start">
                ...
                <span class="mt-2 block w-full text-left font-semibold text-gray-900 text-[14px] md:text-[16px]">
                  {{(money(discountedPrice(selected_variant)))}}
                </span> 
                <div 
              ...
              <div class="button-holder-wrapper button-holder-wrapper-abtest mb-[150px] md:mb-[0px]">
          ...
          <div v-for="option in productOptions"> 
              ...
              <div class="w-full bg-white fixed md:relative bottom-0 left-0 z-[100] p-2 sm:p-0 shadow-[0px_-3px_12px_0px_#0000001A]">

              <button @click="viewProduct" gtm-value="view_product" class="gtm-button-event product__button--secondary-vue text-[#73984a] font-bold text-copy bg-white border border-1 border-prolon_primary border-solid w-full mb-2 p-3 font-medium text-center" type="button" >
              View Product
              </button>
   <button
        ...
        class="bg-[#73984a] w-full gtm-button-event"
        :class="
        {  
  ...
  methods: {
    ...
    viewProduct(e) {
      this.buttonEvent(e.currentTarget)
      window.location.href = this.product.url;
    },
    buttonEvent(element) {
      console.log("GTM - Event executed start");
      let gtmValue = element.getAttribute("gtm-value");
...
window.isCollectionwithVueLoadedx = false;
if (
  document.querySelector(".collection-with-vue-x") &&
  !window.isCollectionwithVueLoadedx
) {
  window.isCollectionwithVueLoadedx = true;
  console.log("collection-with-vuex loading");
  const productImage = Vue.ref(null);

  document.querySelectorAll(".collection-with-vue-x").forEach((el) => {
